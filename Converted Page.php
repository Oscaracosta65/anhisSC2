...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    ...
    $doc->setMetaData('description', 'Verified draw results, frequency analysis, hot and quiet number trends, and draw history for ' . $stateName . ' ' . $gName . '. Analytical intelligence by LottoExpert.net.');
}
 ...
 * --------------------------------------------------------------------------
 */
$jsonLdPageName  = isset($stateName, $gName) ? htmlspecialchars($stateName . ' ' . $gName . ' Results Intelligence', ENT_QUOTES, 'UTF-8') : 'Lottery Results Intelligence';
$jsonLdPageUrl   = htmlspecialchars($canonicalNoQuery, ENT_QUOTES, 'UTF-8');
$jsonLdDatasetName = isset($stateName, $gName) ? htmlspecialchars($stateName . ' ' . $gName . ' Draw Frequency Dataset', ENT_QUOTES, 'UTF-8') : 'Lottery Draw Frequency Dataset';
?>
<style>
:root{
  --skai-blue:#1C66FF;
...
$jsonLdPage = [
    ...
    '@type'       => 'WebPage',
    'name'        => isset($stateName, $gName) ? $stateName . ' ' . $gName . ' Results Intelligence' : 'Lottery Results Intelligence',
    'url'         => $canonicalNoQuery,
    'description' => isset($stateName, $gName) ? 'Frequency analysis, draw history, active and quiet number trends for ' . $stateName . ' ' . $gName . '.' : 'Lottery frequency and draw history analysis.',
    'inLanguage'  => 'en',
    'publisher'   => ['@type' => 'Organization', 'name' => 'LottoExpert.net', 'url' => 'https://lottoexpert.net'],
];
echo '<script type="application/ld+json">' . json_encode($jsonLdPage, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) . '</script>' . "\n";
?>
      ...
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=SC2">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=SC2">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced tools">
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=SC2">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=SC2">MCMC Markov Analysis</a>
    ...
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Start with a clear high-level view. This layer is designed for fast orientation: which numbers are most active in the current <?php echo (int) $nodCurrentMain; ?>-draw window, which are quiet, and how the current draw relates to recent history.
        </p>
      </div>
    </div>
            ...
            <div class="skai-history-list">
              <?php foreach ($drawHistoryRows as $dhr) : ?>
                <div class="skai-history-item">
                  <div class="skai-history-name"><?php echo htmlspecialchars((string) $dhr['label'], ENT_QUOTES, 'UTF-8'); ?></div>
                  <div class="skai-history-date">
                    <?php if (!empty($dhr['prevDate'])) : ?>
                      Previously seen on <?php echo htmlspecialchars(leFmtDateLong((string) $dhr['prevDate']), ENT_QUOTES, 'UTF-8'); ?>
                    <?php else : ?>
                      No previous appearance found in the loaded historical set
                    <?php endif; ?>
                  </div>
                  <div class="skai-history-badge">
                    <?php echo ($dhr['drawsAgo'] !== null) ? (int) $dhr['drawsAgo'] . ' drws ago' : '&mdash;'; ?>
                  </div>
                </div>
              <?php endforeach; ?>
            </div>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The first panel below shows the complete main-number distribution across all values 01&ndash;<?php echo (int) $gameMainMax; ?>. The second panel shows the recency distribution for each number in the selected window.
        </p>
      </div>
    </div>
      ...
      <div class="skai-two-col">
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--horizon">
            ...
            <span class="skai-card-sub">All values 01&ndash;<?php echo (int) $gameMainMax; ?> across the last <?php echo (int) $nodCurrentMain; ?> drawings</span>
          </div>
          <div class="skai-card-body">
            <div class="skai-chart-shell">
        ...
        <div class="skai-card">
          <div class="skai-card-head skai-card-head--ember">
            ...
            <span class="skai-card-sub">Distance since last appearance for each main number (01&ndash;<?php echo (int) $gameMainMax; ?>)</span>
          </div>
          <div class="skai-card-body">
            <div class="skai-chart-shell">
              <div class="skai-chart-frame skai-chart-frame--tall">
  ...
  <section id="tables" class="skai-section" aria-labelledby="tables-title">
    ...
    <div class="skai-section-body">
      <div class="skai-card">
        <div class="skai-card-head skai-card-head--horizon">
          Main numbers table
          <span class="skai-card-sub">Exact counts and recency for values 01&ndash;<?php echo (int) $gameMainMax; ?></span>
        </div>
      ...
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=SC2">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=SC2">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=SC2">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=SC2">MCMC Markov Analysis</a>
  ...
  <section class="skai-section" aria-labelledby="method-title">
    ...
    <div class="skai-section-body">
      <div class="skai-method-note">
        <strong>Interpretation guidance:</strong> Frequency, recency, and spacing can provide useful context for reviewing draw history, but they should be treated as descriptive signals rather than guarantees. The purpose of this page is to make the recent behavior of the game easier to understand, compare, and carry into deeper SKAI analysis. All data reflects verified draw records within the selected analysis window.
      </div>
    </div>
  </section>
...
(function () {
  ...
  function renderCharts() {
    ...
    if (topActiveCanvas && chartData.topActiveLabels.length > 0) {
    ...
    if (quietCanvas && chartData.quietLabels.length > 0) {
    ...
    if (fullMainCanvas && chartData.mainLabels.length > 0) {
    ...
    if (recencyCanvas && chartData.mainLabels.length > 0) {
